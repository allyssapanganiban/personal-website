import educationbot from '../assets/educationbot.png'
...
const mywork_data = [
    {
        w_no:1,
        w_name:"Education Bot",
        w_img: educationbot,
        w_desc: "An AI-driven customer support RAG bot that assists navigating university.",
        w_stack: "Javascript (Next.js), MaterialUI, Firebase, OpenAI API, Langchain, Supabase Vectore Store",
        w_github: "https://github.com/allyssapanganiban/customer-support-ai",
    },
    // {
    //     w_no:2,
    ...
    //     w_stack: "Javascript (Next.js), Gemini API",
