      ...
      <div className="about-sections">
        ...
        >
            <div className="about-para">
                ...
                <p>I am a senior at <b>Villanova University</b> pursuing Computer Science with a minor in Business. I am a driven learner who is curious in the intersection between engineering, user experience, and product thinking, and I am fascinated by leveraging technology to create meaningful impact.</p>
                <p> My primary interests currently lie in <b>full-stack development</b>, <b>AI/ML</b>, and <b>product development</b> - I love building thoughtful applications that are not only technically sound but also designed with the end-user in mind. Simultaneously, I enjoy uncovering insights through data and working cross-functionally to bring ideas to life. Here are some technologies I have been working with:</p>
            </div>
            {/* Skills */}
